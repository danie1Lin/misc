...
import (
	...
	"practice/restapi/operations"
	"practice/restapi/operations/todos"
)

//go:generate swagger generate server --target ../../swagger_practice --name TodoList --spec ../swagger.yml --principal interface{}
